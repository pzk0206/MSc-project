...
| 正式确定性单头五 seed | `data/processed/vlm/cnn_grasp_single_head_deterministic/multi_run_summary.json` | `vlm_cnn_single_multi_run` | seeds 42--46、独立预测和真实最佳验证损失已审计 | 论文固定目录五 seed 主表 |
| 正式确定性多头五 seed | `data/processed/vlm/cnn_grasp_multi_head_deterministic/multi_run_summary.json` | `vlm_cnn_multi_head_multi_run` | seeds 42--46、独立预测和真实最佳验证损失已审计 | 论文固定目录五 seed 主表 |
...
121f11db130539cbcba13a2af65b6dcd8870b5839dc86ac2f1a0eaf9eba06727  data/processed/vlm/cnn_grasp_single_head_deterministic/multi_run_summary.json
3ce94551b9e08daf4f84ce149a79ccff96dad8f3c62687d4c258a717c7ede4a8  data/processed/vlm/cnn_grasp_multi_head_deterministic/multi_run_summary.json
...
- 论文固定目录单头/多头五 seed 表使用两个 `*_deterministic` 目录；旧
  `cnn_grasp/` 聚合只保留为历史结果，不替代正式对照。
